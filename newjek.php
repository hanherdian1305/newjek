...
echo "\e[96m          INI SCRIPT TERMUX GRATIS GOJEK ALL                \n";
echo "\e[96m           JADI GUNAKANLAH DENGAN BIJAK                 \n";
echo "\e[96m          ORDER HEMAT DENGAN KODE VOUCHER               \n";
echo "\e[96m           BE SAFE AND BE HEALTH ALWAYS               \n";
echo "\e[96m            PASUKAN PEMBURU VOUCHER GRATIS                    \n";
echo "\e[96m       BANYAK BERDOA YA SUPAYA JOSS SCRIPT NYA         \n";
echo "\e[96m             * REPACK BY  : MR. BLAO - BLAO *            \n";
...
// function change(){
        ...
        echo color("nevy","\n▬▬▬▬▬▬▬▬▬▬▬▬* BERDOA DULU YA *▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","# CLAIM VOUCHER JAJAN ");
        echo "\n".color("yellow","# TUNGGU YEEE.. ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("nevy","# CLAIM VOUCHER GOFOOD 20K+10K");
        echo "\n".color("yellow","# BANYAK BERDOA , hehehehehe ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(15);
        }
        ...
        echo "\n".color("yellow","SAMPE JOSSSSssss");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(15);
        }
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAUGOFOOD2206"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🔓▶️ Message: ".$message);
        echo "\n".color("nevy","# COBA LAGI VOUCHER JAJAN");
        echo "\n".color("yellow","# SABAR YA , ISTIGFAR DULU YANG BANYAK");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(5);
        }
